...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    void initState() {
      ...
      _firstNameFieldController.text = store1.user.firstName;
      _lastNameFieldController.text = store1.user.lastName;
      _emailController.text = store1.user.email;
      _birthdayController.text = store1.user.birthday;
    }
            ...
            child: Column(
              children: [
                FormBuilder(
                    key: _formKey,
                    initialValue: {
                      'firstName': store1.user.firstName,
                      'lastName': store1.user.lastName,
                      'email': store1.user.email,
                      'birthday': store1.user.birthday,
                    },
