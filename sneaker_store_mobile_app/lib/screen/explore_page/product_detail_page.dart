...
double screenHeight = MediaQuery.of(context).size.height;
    ...
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              DropDownWidget(title: "Product Detail", items: [
                DropDownItem(label: "Brand", value: widget.product.productCollection.brand.brandName),
              ...
              DropDownWidget(title: "Shipping Method", items: [
                DropDownItemShipping(title: "Standard Shipping", subtitle: "Delivery in 5-7 days")
              ]),
      ...
      child: Row(
        ...
        children: [
          BorderIconWithText(icon: Icons.verified, text: "100% Authentic Gurantee"),
          BorderIconWithText(icon: Icons.security, text: "Anti Fraudulent Transaction"),
        ],
      ),
    ),
              // Statistics
      ...
      children: [
        Container(
            ...
            child: Center(child: StatisticBox(label: "Sold", value: "211 Items"))),
        Container(
            color: const Color.fromARGB(31, 128, 128, 128),
            
            padding: EdgeInsets.fromLTRB(50, 14, 50, 14),
            child: Center(child: StatisticBox(label: "Average Price", value: "฿5,212"))), // Adjust value as needed
      ],
    )
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  fixedSize: Size((screenWidth /2) -16, 50), // Adjust width and height as needed
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          8,
                          (index) => SelectableBox(isSelectedList: isSelectedList, price: index+1, index: index)
                        ),
                      ),
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        widget.isSelectedList[widget.index] = !widget.isSelectedList[widget.index];
      ...
      child: Container(
        ...
        width: 50,
        height: 50,
        color: widget.isSelectedList[widget.index] ? Colors.black : Colors.white,
        child: Center(
          child: Text(
            '\$${widget.price}',
            style: TextStyle(
              color: widget.isSelectedList[widget.index] ? Colors.white : Colors.black,
              fontWeight: FontWeight.bold,
            ),
          ),
        ),
        ...
        16), // Adjust the vertical spacing between product name and details boxes
              Row(
                ...
                children: [
                   ...
                   BuildPriceBox(title: "Starting from", value: product.startingPrice?.toString() ?? "No Price Yet!"),
                BuildPriceBox(title: "Retail Price", value: product.retailPrice?.toString() ?? "No Price Yet!"),
              BuildPriceBox(title: "Last Sale", value: product.lastSalePrice?.toString() ?? "No Price Yet!")
                ],
              ),
            ],
          ),
...
// class BuildSlidablePictures extends StatelessWidget {
//   const BuildSlidablePictures({
//     super.key,
//   });
